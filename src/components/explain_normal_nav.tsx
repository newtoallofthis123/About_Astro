...
export default function ExplainIndexNav() {
        ...
        <>
            <nav>
                ...
                "
                    id="nav"
                >
                    <div className="flex flex-row border-b-2 justify-center items-center p-5">
                        <a
                            href="/explains"
                            className="
                    px-5
                    ...
                    "
                        ...
                        {nav && (
                            <motion.div
                                className="fixed flex bottom-0 left-0 w-full h-screen items-center justify-center"
